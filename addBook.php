                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <select name="authorname" class="form-control">
                                                                            <option value="none" selected="" disabled="">Select Auther</option>
                                                                            <?php while ($row = mysqli_fetch_array($resultAuthorList)) {   ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input name="publishdate" id="finish" type="text" class="form-control" placeholder="Publish Date">
                                                                    </div>
