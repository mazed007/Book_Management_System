...
$resultBookList = mysqli_query($conn, $query);
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Book Data Table</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Books <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="bookname" data-editable="false">Book Name</th>
                                                <th data-field="authorname" data-editable="false">Author Name</th>
                                                
                                                <th data-field="category">Category</th>
                                                <th data-field="publishdate" data-editable="false">Publish Date</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                             ...
                                             while ($row = mysqli_fetch_array($resultBookList)) {
                                            ...
                                            <tr>
                                                ...
                                                <form id="demo-form2" method="GET" action="editBook.php?id=<?php echo $row['id']; ?>" enctype="multipart/form-data" role="form" data-parsley-validate class="form-horizontal form-label-left">
                                    
                                    <button type="Submit" name="id" value="<?php echo $row['id']; ?>" class="btn btn-danger">Edit</button>


                                  </form>
                                  <br> <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#Modal_delete" onclick="changeDeleteBookInfo('<?php echo $row['id']; ?>', '<?php echo $row['bookname']; ?>')">Delete</button>
                                            </td>
                                            </tr>
...
<h4 id="deleteBookMessage">Will </h4>
</div>
...
<input id="deleteBookId" name="id" type="hidden" value="0">
<input type="submit" name="bookDelete" class="btn btn-danger" value="Yes">
...
<script>
function changeDeleteBookInfo(id, name) {
document.getElementById("deleteBookMessage").innerHTML = "Will You Really Delete <span style='color:blue'>" + name + "</span> Book";
