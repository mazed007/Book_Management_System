    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.php"><img class="main-logo" src="img/bookLi.jpg" alt="" height="60px" width="130px" /></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Author</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Professors" href="addAuther.php"><span class="mini-sub-pro">Add Author</span></a></li>
                                <li><a title="Add Professor" href="autherList.php"><span class="mini-sub-pro">Author List</span></a></li>

                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="all-students.html" aria-expanded="false"><span class="educate-icon educate-library icon-wrap"></span> <span class="mini-click-non">Book</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                
                                <li><a title="Add Students" href="addBook.php"><span class="mini-sub-pro">Add Book</span></a></li>
                                <li><a title="Edit Students" href="bookList.php"><span class="mini-sub-pro">Book List</span></a></li>
