                    ...
                    <div class="panel-body">
                        <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" id="login" method="POST">
                            <div class="form-group">
                                ...
                                <input type="email" placeholder="example@gmail.com" title="Please enter you email"
                            ...
                            <input class="btn btn-success btn-block loginbtn" type="submit" value="login" name="login">
