...
$query = "SELECT * from addauthor";
$resultAuthorList = mysqli_query($conn, $query);
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Author Data Table</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Author <span class="table-project-n">Data</span> Table</h1>
                                </div>
                            </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="dateofbirth" data-editable="false">Date of Birth</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                             ...
                                             while ($row = mysqli_fetch_array($resultAuthorList)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                  <form id="demo-form2" method="GET" action="editAuthor.php?id=<?php echo $row['id']; ?>" enctype="multipart/form-data" role="form" data-parsley-validate class="form-horizontal form-label-left">
                                    
                                    <button type="Submit" name="id" value="<?php echo $row['id']; ?>" class="btn btn-danger">Edit</button>


                                  </form>
                                 <br> <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#Modal_delete" onclick="changeDeleteAutherInfo('<?php echo $row['id']; ?>', '<?php echo $row['full_name']; ?>')">Delete</button>
                                </td>
                                            </tr>
...
<h4 id="deleteAutherMessage">Will </h4>
</div>
...
<input id="deleteAutherId" name="id" type="hidden" value="0">
<input type="submit" name="autherDelete" class="btn btn-danger" value="Yes">
...
<!-- modal end -->
<script>
function changeDeleteAutherInfo(id, name) {
document.getElementById("deleteAutherMessage").innerHTML = "Will You Really Delete <span style='color:blue'>" + name + "</span> Authors";
document.getElementById("deleteAutherId").value = id;
}
</script>
